...
:root {
  ...
  --gradient-dusk-gradient: linear-gradient(
    ...
    rgb(34, 31, 29),
    rgb(49, 43, 43) 28%,
    rgba(41, 57, 105, 0.9) 50%
  );

  /* Typography — Font Families */
  --font-gt-america:
    "GT America", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-ui-monospace-monospace:
    "ui-monospace / monospace", ui-monospace, SFMono-Regular, Menlo, Monaco,
    Consolas, monospace;
  --font-monospace:
